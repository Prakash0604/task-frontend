...
export default function Hero() {
  return (
    <section className="relative pt-20 pb-32 overflow-hidden bg-gradient-to-b from-white to-gray-50">
      <div className="absolute inset-0 bg-bottom bg-no-repeat bg-contain opacity-10"></div>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6">
            <span className="text-primary">Simplify your tasks.</span>
            <br />
            <span className="text-gray-900">Amplify your productivity.</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            TaskVista helps teams organize, track, and manage their work with
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Button
              size="lg"
              className="font-bold p-6 px-8 bg-primary text-white cursor-pointer"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-gray-300 font-bold text-gray-700 hover:bg-gray-100 p-6 px-8 cursor-pointer"
            >
              See how it works
            </Button>
          </div>
        ...
        <div className="relative max-w-5xl mx-auto ">
          ...
          <div className="rounded-2xl shadow-2xl overflow-hidden border border-gray-200 bg-white">
            <div className="h-8 bg-gray-100 flex items-center border-b border-gray-200 relative">
                ...
                <div className="space-y-2">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="flex items-center gap-3">
                      <div className="w-4 h-4 p-2 rounded-full bg-purple-200"></div>
              ...
              <div className="flex-1 p-6 ">
                ...
                <div className="space-y-4">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="p-4 bg-white rounded-lg border border-gray-200 flex items-start gap-3"
                    >
          ...
          {/* Floating elements */}
          <div className="absolute -top-6 -left-6 w-16 h-16 bg-gray-200 rounded-lg animate-[bounce_4s_ease-in-out_infinite]"></div>
          <div className="absolute -bottom-8 -right-8 w-20 h-20 bg-purple-200 rounded-full animate-[bounce_4s_ease-in-out_infinite]"></div>
          <div className="absolute top-1/6 -right-4 w-10 h-10 bg-purple-300 rounded-lg animate-[bounce_4s_ease-in-out_infinite]"></div>
        </div>
      </div>
    </section>
  );
