...
const pricingPlans = [
  ...
  },
  {
    ...
    popular: true,
    border: true, // Added this flag for the red border
  },
  {
    name: "Enterprise",
    price: "$19",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Whether you&apos;re an individual or a large team, we have a plan
            ...
            >
              {plan.popular && (
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  <span className="bg-primary font-bold text-white px-3 py-1 rounded-full text-xs ">
                    Most Popular
                  </span>
                </div>
              )}
              ...
              <CardFooter className="pt-4">
                <Button
                  ...
                  className={`w-full ${
                    plan.popular ? "bg-primary hover:bg-taskpurple-600" : ""
                  }`}
                >
                  {plan.cta}
                </Button>
