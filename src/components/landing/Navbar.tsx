      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-10">
            <a
              href="#features"
              className="text-base font-medium text-gray-700 hover:text-taskpurple-500 transition-colors"
            >
              Features
            </a>
            <a
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-b border-gray-200">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="pt-4 pb-2 border-t border-gray-200 bg-primary">
              <Button variant="outline" className="w-full mb-2">
                Log in
              </Button>
              <Button
                variant="default"
                className="w-full bg-primary hover:bg-primary/90 text-blue-500"
              >
                Sign up free
              </Button>
            </div>
